...
subset Blade  of MultiVector where .reals.elems == 1;
subset Vector of Blade       where .grades.all == 1;
...
multi infix:</>($x, Blade $A) returns MultiVector is export { $x*$A/($A*$A).Real }
